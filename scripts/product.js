...
const product = JSON.parse(localStorage.getItem(`product-${url.substring(1, url.length)}`))

document.title = product.nome + " - Retrones"
document.getElementById("name").innerHTML = product.nome
document.getElementById("price").innerHTML = "R$" + product.preco
